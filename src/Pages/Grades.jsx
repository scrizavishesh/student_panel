...
import { getAllGradeDataApi } from '../Utils/Apis';
...
const Grades = () => {
    ...
    const getAllGrades = async () => {
        try {
            setloaderState(true);
            var response = await getAllGradeDataApi(searchByKey, pageNo, pageSize);
                ...
                <table className="table align-middle table-striped">
                    <thead>
                        <tr>
                            ...
                            <td className='font14'>Grade Point</td>
                            <td className='font14'>Mark From</td>
                            <td className='font14'>Mark Upto</td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr></tr>
                        {GradeData.map((item, index) => (
                            <tr key={item.id}>
                                ...
                                <td className='font14 greyText'>{item.gradePoint}</td>
                                <td className='font14 greyText'>{item.marksFrom}</td>
                                <td className='font14 greyText'>{item.marksUpTo}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
